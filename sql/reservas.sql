...
CREATE TABLE "asientos" (
  ...
  CONSTRAINT "asiento_por_funcion_unico"
    UNIQUE ("id_funcion_externa", "fila", "numero")
);
...
COMMENT ON TABLE "estado_reserva" IS 'Temporal, Confirmada, Expirada o Rechazada';
...
CREATE INDEX "ix_boletos_funcion_externa"
  ON "boletos" ("id_funcion_externa");

CREATE INDEX "ix_boletos_pelicula_externa"
  ON "boletos" ("id_pelicula_externa");

CREATE INDEX "ix_boletos_fecha_funcion"
