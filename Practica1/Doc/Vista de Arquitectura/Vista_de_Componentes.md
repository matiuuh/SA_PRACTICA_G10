...
4. Servicio de Peliculas y Cartelera  
5. Servicio de Funciones  
6. Servicio de Reservas y Asientos  
7. Servicio de Pagos  
...
- Servicio de Peliculas -> Base de Datos Peliculas
...
- Movie Service gestiona peliculas y cartelera.
...
Los procesos criticos relacionados con reservas y pagos utilizan RabbitMQ como broker de mensajeria para garantizar procesamiento asincrono, tolerancia a fallos y manejo adecuado de concurrencia.

El diagrama muestra persistencia separada para usuarios, peliculas y funciones mediante bases de datos PostgreSQL dedicadas. Ademas, el Servicio de Pagos consume una pasarela de pago simulada mediante REST API y el Servicio de Notificaciones se integra con un proveedor de email mediante SMTP o API.
