...
| RF-09 | Alta | Expiración de Reserva Temporal | El sistema debe liberar automáticamente los asientos bloqueados temporalmente si el usuario no completa el pago dentro del tiempo límite establecido. |
| RF-10 | Alta | Flujo de Compra de Boletos | El sistema debe procesar el flujo completo de compra: confirmación de selección de asientos, procesamiento de pago simulado y emisión del boleto final. |
| RF-11 | Alta | Procesamiento de Pago Simulado | El sistema debe permitir al usuario confirmar su compra a través de un proceso de pago simulado, validando la disponibilidad de los asientos seleccionados antes de proceder. |
| RF-12 | Alta | Emisión de Boleto | Tras la confirmación del pago, el sistema debe generar y entregar al usuario un boleto digital con los detalles de la función, asientos y número de confirmación. |
| RF-13 | Media | Historial de Compras | El sistema debe permitir al usuario consultar el historial de boletos adquiridos con sus detalles. |
