...
| RNF-02 | Manejo de condiciones de carrera | El sistema debe garantizar que no ocurran condiciones de carrera al seleccionar asientos de forma simultánea. Debe soportar al menos 100 usuarios concurrentes intentando reservar asientos en la misma función sin inconsistencias de datos. |
...
| RNF-05 | Autenticación y autorización | Todas las rutas protegidas deben validar un token JWT con expiración máxima de 1 hora. Las contraseñas deben almacenarse cifradas con un bcrypt. |
