-- Schema: pagos_service
-- Ejecutar como superuser: psql -h <IP> -U postgres -d pagos_service -f pagos_service.sql

GRANT ALL ON SCHEMA public TO pagos_user;
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO pagos_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO pagos_user;
